...
## The Problem with If
 ...
 The left-hand side of the image below shows an if statement with an enum. You can see that a lot of text is repeated and the enum cases get a little lost in the rest of the code:
 ...
 The right-hand side of the image highlights another problem with the if statement: The last choice isn’t really _anything_ else, it’s soup. If you were reading this code without knowing the last case in the enum, you’d have to guess.
