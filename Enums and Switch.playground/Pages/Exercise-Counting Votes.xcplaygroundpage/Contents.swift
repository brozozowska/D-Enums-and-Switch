 ...
 */
var beachVotes = 0
var chocolatFactoryVotes = 0

for vote1 in tripDestinationVotes {
    switch vote1 {
    case .beach: beachVotes += 1
    case .chocolateFactory: chocolatFactoryVotes += 1
    }
}
/*:
### Extension:
...
for vote2 in mascotVotes {
    switch vote2 {
        case .marmot: marmotVotes += 1
        case .salamander: salamanderVotes += 1
        case .neither: neitherVotes += 1
    }
}
/*:
 - callout(Exercise): 
